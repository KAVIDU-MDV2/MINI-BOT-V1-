...
*│┌───────➣*
*││•ᴀʟɪᴠᴇ [ ʙᴏᴛ ᴀʟɪᴠᴇ ]*
*││•ᴍᴇɴᴜ [ ʙᴏᴛ ᴍᴇɴᴜ ʟɪꜱᴛ ᴍᴀɪɴ ]*
*││•ꜱʏꜱᴛᴇᴍ [ ʙᴏᴛ ꜱʏꜱᴛᴇᴍ ]*
*││•ꜱᴏɴɢ [ꜱᴏɴɢ ᴅᴏᴡɴʟᴏᴅᴇʀ ]*
*││•ꜰʙ [ꜰᴀᴄᴇʙᴏᴏᴋ ᴅᴏᴡɴʟᴏᴅᴇʀ ]*
*││•ꜱᴘᴏᴛɪꜰʏ [ ꜱᴘᴏᴛɪꜰʏ ᴅᴏᴡɴʟᴏᴅᴇʀ ]*
*││•ᴛᴛ [ ᴛɪᴋ ᴛᴏᴋ ᴅᴏᴡɴʟᴏᴅᴇʀ]*
*││•ᴠᴏɪᴄᴇ [ ꜱᴏɴɢ ᴠᴏɪᴄᴇ ᴛᴘᴘ]*
*││•ꜰᴀɴᴄʏ [ ꜰᴏɴᴛ ꜱᴛʏʟᴇ ]*
*││•ᴀɪɪᴍᴀɢᴇ [ ᴀɪ ɪᴍᴀɢᴇ ᴄᴏɴᴠᴇʀᴛ]*
*││•ᴊɪᴅ [ ᴀʟʟ ᴊɪᴅ ]*
*││•ɴɪᴋᴏ [ ʀᴀɴᴅᴏᴍ ᴀɴɪᴍᴇ ɪᴍᴀɢᴇ]*
*││•ɢᴏꜱꜱɪᴘ [ ɢᴏꜱɪᴘ ɴᴇᴡꜱ ]*
*││•ɴᴀꜱᴀ [ ɴᴀꜱᴀ ɴᴇᴡꜱ ]*
    ...
    const templateButtons = [
        {
            ...
            buttonText: { displayText: 'ʙʟᴏᴏᴅ x ᴍɪɴɪ ᴘɪɴɢ ꜱɪɢɴᴀʟ' },
            type: 1,
        },
        {
            buttonId: `${config.PREFIX}alive`,
            buttonText: { displayText: 'ʙʟᴏᴏᴅ x ᴍɪɴɪ  ᴀʟɪᴠᴇ' },
            type: 1,
        },
        {
            buttonId: `${config.PREFIX}owner`,
            buttonText: { displayText: 'ʙʟᴏᴏᴅ x ᴍɪɴɪ ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ' },
            type: 1
        }
    ];
