...
*╭────༺༻────➜*
*│┌─────────➜*
❖││𝐁𝐎𝐓 𝐔𝐏 𝐓𝐈𝐌𝐄 ➳ ${hours}h ${minutes}m ${seconds}s*
❖││𝐁𝐎𝐓 𝐀𝐂𝐓𝐈𝐕𝐄 𝐂𝐎𝐔𝐍𝐓  ➳ *${activeSockets.size}*
❖││𝐌𝐈𝐍𝐈 𝐕𝐄𝐑𝐒𝐈𝐎𝐍 ➳ 1.0.0 ᴠ*
❖││𝐑𝐀𝐌 𝐔𝐒𝐄𝐆𝐄 ➳ 362520/320 GB*
❖││𝐃𝐄𝐏𝐋𝐎𝐘 𝐏𝐋𝐀𝐓𝐅𝐑𝐎𝐌 ➳ Heroku ❲ ꜰʀᴇᴇ ❳*
❖││𝐌𝐈𝐍𝐈 𝐁𝐎𝐓 𝐎𝐖𝐍𝐄𝐑 ➳ 94761332610*
*│└─────────➜*
*╰────༺༻────➜*

> ❖𝐊𝐀𝐕𝐈𝐃𝐔 𝐌𝐃 𝐌𝐈𝐍𝐈 𝐁𝐎𝐓 𝐕1 𝐌𝐄𝐍𝐔 ☠️

*┌──────༒───⫸*
*│┌───────⫸*
❖││•𝘼𝙇𝙄𝙑𝙀 [ 𝘽𝙊𝙏 𝘼𝙇𝙄𝙑𝙀 ]*
❖││•𝙈𝙀𝙉𝙐 [ 𝘽𝙊𝙏 𝙈𝙀𝙉𝙐 𝙇𝙄𝙎𝙏 𝙈𝘼𝙄𝙉 ]*
❖││•𝙎𝙊𝙉𝙂 [𝙎𝙊𝙉𝙂 𝘿𝙊𝙒𝙉𝙇𝙊𝘿𝙀𝙍 ]*
❖││•𝙁𝘽 [ 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆 𝘿𝙊𝙒𝙉𝙇𝙊𝘿𝙀𝙍 ]*
❖││•𝙎𝙋𝙊𝙏𝙄𝙁𝙔 [ 𝙎𝙋𝙊𝙏𝙄𝙁𝙔 𝘿𝙊𝙒𝙉𝙇𝙊𝘿𝙀𝙍 ]*
❖││•𝙏𝙏 [ 𝙏𝙄𝙆 𝙏𝙊𝙆 𝘿𝙊𝙒𝙉𝙇𝙊𝘿𝙀𝙍 ]*
❖││•𝙑𝙊𝙄𝘾𝙀 [ 𝙎𝙊𝙉𝙂 𝙑𝙊𝙄𝘾𝙀 𝙏𝙋𝙋 ]*
❖││•𝙁𝘼𝙉𝘾𝙔 [ 𝙁𝙊𝙍𝙉𝙏 𝙎𝙏𝙔𝙇𝙀 ]*
❖││•𝘼𝙄𝙄𝙈𝘼𝙂𝙀 [ 𝘼𝙄 𝙄𝙈𝘼𝙂𝙀 𝘾𝙊𝙉𝙑𝙀𝙍𝙏 ]*
❖││•𝙅𝙄𝘿 [ 𝘼𝙇𝙇 𝙅𝙄𝘿 ]*
❖││•𝘿𝙀𝙇𝙀𝙏𝙀𝙈𝙀 [ 𝙆𝘼𝙑𝙄𝘿𝙐 𝙈𝘿 𝙈𝙄𝙉𝙄 𝘽𝙊𝙏 𝙎𝙀𝙎𝙎𝙄𝙊𝙉 𝘿𝙀𝙇𝙀𝙏𝙀𝙈𝙀 ]*
*│└────────⫸*
*└──────༒───⫸*

*_𝗔𝗨𝗧𝗢𝗠𝗔𝗧𝗜𝗖𝗔𝗟𝗬 ▬ 𝗦𝗘𝗧𝗧𝗜𝗡𝗚 ⚙️_*
    ...
    const templateButtons = [
        {
            ...
            buttonText: { displayText: ' ᴋᴀᴠɪᴅᴜ ᴍɪɴɪ ᴘɪɴɢ ꜱɪɢɴᴀʟ' },
            type: 1,
        },
        {
            buttonId: `${config.PREFIX}alive`,
            buttonText: { displayText: 'ᴋᴀᴠɪᴅᴜ ᴍɪɴɪ  ᴀʟɪᴠᴇ' },
            type: 1,
        },
        {
            buttonId: `${config.PREFIX}owner`,
            buttonText: { displayText: 'ᴋᴀᴠɪᴅᴜ ᴍɪɴɪ ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ' },
            type: 1
        }
    ];
...
case 'ping': {
    ...
    await socket.sendMessage(m.chat, {
        text: `*ᴋᴀᴠɪᴅᴜ 𝘟 𝘔𝘐𝘕𝘐 𝘗𝘐𝘕𝘎* ▻ \`4.01ms\`\n\n ʙᴏᴛ ɪꜱ ᴀᴄᴛɪᴠᴇ ᴛᴏ ꜱɪɢɴᴀʟ💣💥*`,
        edit: loading.key
    });
